...
def main():
    ...
    print(tag_ok + " Starting URLKAR13MA09 with Template '{t}' and payload '{payload}'.".format(t=template, payload=payload))
    ...
    if(checkTemplate(template) == True):
        ...
        print(tag_ok + " Use URLKAR13MA09 -template <template name> -payload <payload path>")
        exit(True)
